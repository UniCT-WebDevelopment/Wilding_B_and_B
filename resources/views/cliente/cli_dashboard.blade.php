...
<head>
  ...
  <script>console.log("<?=  $data['email'] ?>" );</script>")
</head>
...
<body class="">
    ...
    <div class="sidebar" data-color="danger" data-background-color="white" data-image="{{ url('/') }}/client_assets/img/sidebar-1.jpg">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{ route('cli_tables',['user' => $data['email']]) }}">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">La tua dashboard {{ $data['name'] }}</a>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            {{ csrf_field() }}
              ...
              <input type="hidden" name="utente" value= "cliente" />
                <input type="text" name="cit_value" class="form-control" placeholder="Cerca luogo...">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Ultima prenotazione {{ $data['prenote_data'] }}</p>
                  <h3 class="card-title">{{ $data['prenote_inf'] }} <em id="nome_bnb"><b>{{ $data['prenote_name'] }}</b></em>
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="https://www.google.it">Dettagli della prenotazione</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">Avviso</p>
                  <h3 class="card-title">Nessun soggiorno in scadenza</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">weekend</i> 
					<a href="https://www.google.it">
					Prolunga la prenotazione corrente!
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">{{ $not->data_fine }}</p>
                  <h3 class="card-title">{{ $not->citta.' '.$not->indirizzo_civico  }}</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">weekend</i> 
					<a href="/prenota?user={{ $data['email'] }}&id={{ $not->id_casa }}">
					Prolunga la prenotazione corrente!
                  </div>
                </div>
              </div>
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ url('/') }}/client_assets/img/sidebar-1.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ url('/') }}/client_assets/img/sidebar-2.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ url('/') }}/client_assets/img/sidebar-3.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ url('/') }}/client_assets/img/sidebar-4.jpg" alt="">
          </a>
        </li>
  ...
  <script>
    $(document).ready(function() {
      // Javascript method's body can be found in {{ url('/') }}/client_assets/js/demos.js
