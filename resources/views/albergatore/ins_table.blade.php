      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Prenotazioni</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-warning ">
                  <h4 class="card-title ">Le tue inserzioni</h4>
                  <p class="card-category"> Riepilogo dei tuoi ultimi ospiti</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                          ...
                          <td>
                          {{ $item->indirizzo_civico }}
                          </td>
                          <td>
                            {{ substr($item->data_inserimento,0,-8) }}
                          </td>
                          <td >
                            {{ $item->nome_casa }} 
                          </td>
