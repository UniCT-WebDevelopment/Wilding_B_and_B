      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item active  ">
		   ...
		   <li class="nav-item ">
            <a class="nav-link" href="{{ route('alb_annuncio',['user' => $data['email']]) }}">
              <i class="material-icons">local_offer</i>
              <p>Inserisci un nuovo annuncio</p>
            </a>
          </li>
		   </li>
		   <li class="nav-item ">
            <a class="nav-link" href="{{ route('ins_table',['user' => $data['email']]) }}">
              <i class="material-icons">bookmark</i>
              <p>I tuoi annunci</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{ route('pre_table',['user' => $data['email']]) }}">
        ...
        <div class="container-fluid">
          ...
          <form class="navbar-form" method="POST" action="/cerca">
            {{ csrf_field() }}
              ...
              <input type="hidden" name="utente" value= "albergatore" />
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h3 class="card-title">Soggiorno in scadenza</h3>
                </div>
                <div class="card-footer">
                <div class="stats">
                    <i class="material-icons">weekend</i> 
					<a href="https://www.google.it">
					    Prolungamento consentito!
                  </div>
                </div>
              </div>
            </div>
